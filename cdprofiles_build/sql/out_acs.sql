CREATE TEMP TABLE acs as (
    ...
    SELECT
        ...
        (SELECT e FROM demo WHERE variable = 'Pop_1' and geotype='City2010') as pop_acs_nyc,   
        (SELECT e FROM demo WHERE variable = 'Pop_1' and geotype='Boro2010' and geoid=a.borocode) as pop_acs_boro,
