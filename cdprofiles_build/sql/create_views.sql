...
CREATE VIEW cd_built_environment AS (
    SELECT
        ...
        pct_lot_area_res_1_2_family_bldg as pct_lot_area_res_1_2_family_bldg,
        lots_res_multifamily_walkup,
        pct_lot_area_res_multifamily_walkup as pct_lot_area_res_multifamily_walkup,
        lots_res_multifamily_elevator,
        pct_lot_area_res_multifamily_elevator as pct_lot_area_res_multifamily_elevator,
        lots_mixed_use,
        pct_lot_area_mixed_use as pct_lot_area_mixed_use,
        lots_commercial_office,
        pct_lot_area_commercial_office as pct_lot_area_commercial_office,
        lots_industrial_manufacturing,
        pct_lot_area_industrial_manufacturing as pct_lot_area_industrial_manufacturing,
        lots_transportation_utility,
        pct_lot_area_transportation_utility as pct_lot_area_transportation_utility,
        lots_public_facility_institution,
        pct_lot_area_public_facility_institution as pct_lot_area_public_facility_institution,
        lots_open_space,
        pct_lot_area_open_space as pct_lot_area_open_space,
        lots_parking,
        pct_lot_area_parking as pct_lot_area_parking,
        lots_vacant,
        pct_lot_area_vacant as pct_lot_area_vacant,
        lots_other_no_data,
        pct_lot_area_other_no_data as pct_lot_area_other_no_data,
        lots_total,
